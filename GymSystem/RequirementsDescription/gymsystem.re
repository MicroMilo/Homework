...
Basic Flow {  
    ...
    (System) 2. system shall display available courses.//function  
...
Basic Flow {  
    ...
    (System) 2. system shall return all courses Member has reserved.//function  
    (User) 3. the Member shall confirm to cancel a specific one.
    (System) 4. system shall confirm a cancel of booking.//function  
    (User) 5. the Member shall request to refund charge.
    (System) 6. system shall recharge money to member.//function  
}  
Alternative Flow {  
...
{  
Basic Flow {  
    (User) 1. the Trainer shall request to create course.
    (System) 2. system shall return a form for trainer to complete.//function  
    (User) 3. the Trainer shall confirm course information to create.
...
{  
Basic Flow {  
    (User) 1. the Trainer shall request to see all course by itself.
    (System) 2. system shall display courses according to trainer.//function  
    (User) 3. the Trainer shall choose specific one to view.
    (System) 4. system shall return detailed data about it.//function  
    (User) 5. the Trainer shall modify data about course.
...
{  
Basic Flow {  
    (User) 1. the Trainer shall request to finish one course after event.
    (System) 2. system shall display detail infomation about it.//function  
    (User) 3. the Trainer shall confirm to finish course.
    (System) 4. system shall confirm finish.//function   
    (User) 5. the Trainer shall request to have bonus.
    (System) 6. system shall confirm bonus award.//function   
} 
} 